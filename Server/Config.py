...
class Config:
    def __init__(self):
        ...
        self.max_join_wait = 60 #this corresponds to waiting for this times join_sleep_time seconds for players to join a game
        ...
        self.extra_join_time = 30 #give players an extra this number of seconds to create and send their usernames once all players have joined
